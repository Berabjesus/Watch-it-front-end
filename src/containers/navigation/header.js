      ...
      <nav className="navbar d-flex justify-content-between py-3 bg-theme-1">
        {
          ...
          <Link to={`/create/${loginStatus.username}`} className={`d-flex flex-column align-items-center text-white ${headerCss.flex_20}`}>
        ...
        {
          loginStatus.isLoggedIn && (
          <Link to="/login" className={`d-flex flex-column align-items-center text-white ${headerCss.flex_20}`}>
